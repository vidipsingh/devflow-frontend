...
// We read the token, save it to localStorage, then push to /dashboard.
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
    ...
    // Small delay so user sees the "completing" screen, not a flash
    setTimeout(() => router.replace("/dashboard"), 500);
  }, [params, router]);

  return (
    <div className="min-h-screen bg-[#0d0d0f] flex items-center justify-center px-4">
      {/* Background glows matching the auth layout */}
